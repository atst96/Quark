...
public static class AudioDataConverter
{
    ...
    public static T FrequencyToPitch12<T>(T frequency) where T : IFloatingPoint<T>, ILogarithmicFunctions<T>
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static T Pitch12ToFrequency<T>(T pitch) where T : IFloatingPoint<T>, IPowerFunctions<T>
