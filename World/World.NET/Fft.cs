...
internal unsafe static class Fft
{
    ...
    public const int FFT_BACKWARD = 2;
    public const uint FFT_ESTIMATE = 3;
    ...
    public static fft_plan fft_plan_dft_1d(int n, Span<fft_complex> @in, Span<fft_complex> @out, int sign,
        uint flags)
    {
        fft_plan output = default;
        output.n = n;
        output.@in = null;
        output.c_in = @in;
        output.@out = null;
    ...
    public static fft_plan fft_plan_dft_c2r_1d(int n, Span<fft_complex> @in, Span<double> @out,
        uint flags)
    {
        fft_plan output = default;
        output.n = n;
    ...
    public static fft_plan fft_plan_dft_r2c_1d(int n, Span<double> @in, Span<fft_complex> @out,
        uint flags)
    {
        fft_plan output = default;
        output.n = n;
    ...
    public static void fft_execute(ref fft_plan p)
    {
    ...
    public static void fft_destroy_plan(ref fft_plan p)
    {
        p.n = 0;
        p.@in = null;
        p.c_in = null;
